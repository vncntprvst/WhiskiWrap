"""Utility functions for generating or processing video
...
def choose_rectangular_ROI(vfile, n_frames=4, interactive=False, check=True,
    ...
    for frame, ax in zip(frames, axa.flatten()):
        wwutils.plots.imshow(frame, ax=ax, axis_call='image', cmap=plt.cm.gray)
    wwutils.plots.harmonize_clim_in_subplots(fig=f, clim=(0, 255))
